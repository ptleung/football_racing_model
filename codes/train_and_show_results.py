...
football_racing.train_model(df_dict['train']['x1'], df_dict['train']['x2'], df_dict['train']['y'],
                            validation_data=(
                                (df_dict['val']['x1'], df_dict['val']['x2']), df_dict['val']['y']
                            ))
...
# Dsitribution of confidence comparison
prediction_df[(final_prediction == actual_game_result)].std(axis=1).hist()  # plt shown in 'Results/correct_prediction_prob_std_distribution.png'
prediction_df[(final_prediction != actual_game_result)].std(axis=1).hist()  # plt shown in 'Results/incorrect_prediction_prob_std_distribution.png'
